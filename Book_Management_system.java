...
public class OBS_FINAL{
            ...
            while((yes.charAt(0) == 'y' || yes.charAt(0) == 'Y') && (yes.length()==1)){
                ...
                while(check){
                    if(book_price >=1){
                        ...
                        book_price = check_number();
                        check = true;
                    }
                } 
                System.out.println("Enter book quantity: ");
                int book_quantity = check_number();
                check = true;
                while(check){
    ...
    public static void view(File file, String string, BufferedReader line) throws IOException, NullPointerException {
    ...
    public static String address(){
        ...
        int house = check_number();
        System.out.println("Enter Street Number: ");
        int street = check_number();
